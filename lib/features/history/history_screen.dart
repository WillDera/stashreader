                ...
                children: [
                  ...
                  StaggeredEntrance(
                    child: FeaturePanel(
                      ...
                      subtitle:
                          'Your active books are ordered for quick returns and clean resets.',
                      stats: [
                        PanelStat(value: '$count', label: 'Active'),
                        PanelStat(
                          value:
                              '${(_books.fold<double>(0, (sum, b) => sum + b.progress) / count * 100).round()}%',
                          label: 'Average',
                        ),
                        PanelStat(
                          value:
                              '${_books.where((b) => b.progress >= 0.9).length}',
                          label: 'Near end',
                        ),
                      ],
                    ),
